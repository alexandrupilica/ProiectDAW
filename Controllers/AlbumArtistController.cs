...
namespace ProiectDAW.Controllers
{
    ...
    {
        private readonly IAlbumArtistService _service;
        public AlbumArtistController(IAlbumArtistService service)
        {
